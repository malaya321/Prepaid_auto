    ...
    <BodyWarpper>
      ...
      <View style={styles.detaiilscontainer}>
        <View style={styles.topcontainer}>
          ...
          <Text style={styles.customernameanddate}>
            Customer name : {orderData.customer_name}
          </Text>
          <Text style={styles.customernameanddate}>
            Booking date : {orderData.booking_date}
          </Text>
        </View>
        <Text style={styles.tripheader}>Trip Details</Text>
        <View style={styles.secondbox}>
          <Text style={styles.tripdetails}>
            Drop location : {orderData.drop_location}
          </Text>
          <Text style={styles.tripdetails}>
            Amount :₹ {orderData.driver_amount}
          </Text>
          <Text style={styles.tripdetails}>
            Start time : {orderData.start_time}
          </Text>
          <Text style={styles.tripdetails}>
            End time : {orderData.end_time}
          </Text>
          <Text style={styles.tripdetails}>
            Customer number : {orderData.customer_mobile}
          </Text>
          <Text style={styles.tripdetails}>
            Pickup code : {orderData.pickup_code}
          </Text>
          <Text style={styles.tripdetails}>
